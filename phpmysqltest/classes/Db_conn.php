...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'kjmiles';//this will be your WCC username
      $dbUsr = 'kjmiles';//this will be your WCC username
      $dbPass = 'b9b7VeqqaF7e';//this will be the password found in the video.
